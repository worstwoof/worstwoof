...
<h1 style="color: #FFA500;">嗨！欢迎来到黄子豪 (Worstwoof) 的主页! 🍀</h1>
...
* 它能实时检测手掌位置，并在你的手心“凭空”放出**烟花粒子特效**。
...
### 3.  SpaceMusic 音乐网站
* 作为**团队成员**，使用 **HTML/CSS/JavaScript** 开发。
* 该网站融合了 WebGL 动态海浪、GSAP 专业动画、全屏引导特效与贯穿全站的现代毛玻璃UI，并支持明暗双模主题切换。
* 可一键在“3D 歌词音频模式”与“高清 MV 视频模式”间无缝切换，所有控件（进度条、音量、歌词）均能完美自动同步


### 4.  山东产业技术研究院
* 在山东产业技术研究院(青岛)工程师助理岗位实习
...
    <td>
      <picture>
        <source media="(prefers-color-scheme: dark)"  srcset="https://github-readme-activity-graph.vercel.app/graph?username=worstwoof&theme=tokyo-night" />
        <source media="(prefers-color-scheme: light)" srcset="https://github-readme-activity-graph.vercel.app/graph?username=worstwoof&theme=xcode" />
        <img src="https://github-readme-activity-graph.vercel.app/graph?username=worstwoof&theme=tokyo-night" />
      </picture>
  </tr>
</table>
...
<p align="center">
  📫 很高兴认识你！我的邮箱是 <b>zihao.huang.cs@outlook.com</b>，欢迎随时来找我聊技术、聊创意！
</p>
